...
<div class="space-y-2 mb-6 animate-fade-in">
    <?php foreach ($alerts as $a):
        [$cls, $color, $iconPath] = match ($a['type']) {
            ...
            'error'   => ['rgba(244,63,94,0.06)',  '#FB7185', 'M12 8v4m0 4h.01M4.93 19h14.14c1.54 0 2.502-1.667 1.732-3L12.732 4.99c-.77-1.333-2.694-1.333-3.464 0L3.196 16c-.77 1.333.192 3 1.732 3z'],

...
<div class="grid sm:grid-cols-2 gap-3 mb-8">
    <?php foreach ([
        ['icon' => '💬', 'title' => 'WhatsApp conectado', 'desc' => 'Recibe y responde mensajes en automatico desde la inbox.'],
        ['icon' => '🧠', 'title' => 'Agente IA propio',   'desc' => 'Califica leads, recomienda productos y cierra ventas mientras duermes.'],
        ['icon' => '🪄', 'title' => 'Workflows pre-armados', 'desc' => 'Bienvenida automatica, recuperacion de carrito, escalamiento de tickets.'],
        ['icon' => '📊', 'title' => 'Dashboard ejecutivo', 'desc' => 'KPIs cross-feature en una sola vista. Saber como va tu negocio en 10 segundos.'],
    ] as $f): ?>
